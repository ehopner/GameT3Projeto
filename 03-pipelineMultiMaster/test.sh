...
regex_worker3='k8s-workers-4.*?Ready'

if [[ $kubectl =~  $regex_master1 && $kubectl =~  $regex_master2 && $kubectl =~  $regex_worker1 && $kubectl =~  $regex_worker2 && $kubectl =~  $regex_worker3 && $kubectl =~  $regex_worker4 ]]
then 
